...
public interface PipelineEventRepository extends JpaRepository<PipelineEvent, Long> {
    ...
    /**
     * Multi-pod outbox claim (Notifier, T6): the unsent rows ({@code notifiedAt IS NULL}), oldest first,
    ...
    /**
     * Single-rollup dedup for {@link com.bff.pipeline.ops.AlertService}: has an event of {@code type} been
