 ...
 * the {@code postgres} profile and is NOT the default bean — {@code SingleNodeLeader} (returns true) remains
 * the default/test Leader. No H2 test for that reason.
 *
...
@Component
@Profile("postgres")
public class PostgresAdvisoryLockLeader implements Leader {
