...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/WaitingTargetConfirmationStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/WaitingApprovalStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/ApplyingApprovedStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/InstallingStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/WaitingConnectionTestStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/ConnectionVerifiedStep',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/layout/InstallationCompleteStep',
  () => ({
