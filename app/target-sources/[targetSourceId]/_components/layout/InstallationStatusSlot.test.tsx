...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/aws/AwsInstallationStatus',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/azure/AzureInstallationStatus',
  () => ({
...
vi.mock(
  '@/app/target-sources/[targetSourceId]/_components/gcp/GcpInstallationStatus',
  () => ({
