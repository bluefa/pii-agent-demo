...
import { cn, mgmtGroupStyles, textColors, bgColors, statusColors } from '@/lib/theme';
      ...
      {open && (
        <div role="menu" className={cn(mgmtGroupStyles.menu, 'p-1 text-left')}>
          <button
            ...
            className={cn(
              'block w-full text-left px-3 py-2 text-xs font-medium rounded-md',
          ...
          <div className={cn('h-px my-1', bgColors.muted)} />
          <button
            type="button"
            role="menuitem"
