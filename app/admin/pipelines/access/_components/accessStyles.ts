...
export const accessStyles = {
  ...
  /** 이메일도 늘어나는 열이다 — 이름만 flex-1 이면 그 한 열이 남는 폭을 전부 먹고
   *  이메일은 고정 폭 안에서 잘린다. 둘로 나눠야 실제 값 길이에 맞게 갈린다. */
  ...
  pickerName: 'flex-1 min-w-0 truncate text-[14px] font-medium text-[var(--pl-text-strong)]',
