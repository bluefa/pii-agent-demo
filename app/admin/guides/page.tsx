...
import { GuidePlaceholder } from '@/app/admin/guides/components/GuidePlaceholder';
import { GuidePreviewPanel } from '@/app/admin/guides/components/GuidePreviewPanel';
import { ProviderTabs } from '@/app/admin/guides/components/ProviderTabs';
import { StepListPanel } from '@/app/admin/guides/components/StepListPanel';
import { UnsavedChangesModal } from '@/app/admin/guides/components/UnsavedChangesModal';
import type { EditorLanguage } from '@/app/admin/guides/components/EditLanguageTabs';
...
import type { ProviderTab } from '@/app/admin/guides/types';
...
const GuideEditorPanel = dynamic(
  () =>
    import('@/app/admin/guides/components/GuideEditorPanel').then((m) => ({
