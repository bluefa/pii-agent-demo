...
export const ServiceManagementView = () => {
  ...
  return (
    // Exact viewport minus the sticky 72px TopNav — `min-h-screen` here stacked a
    // full 100vh under the nav, so the page scrolled 72px and the left panel ended
    ...
    <div className={cn('h-[calc(100vh-72px)]', serviceSidebarStyles.canvas)}>
