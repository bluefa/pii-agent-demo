...
// GET …/test-connection/latest_version — polling endpoint (ADR-019 zod-codegen).
// Route validates raw BFF response against the swagger schema; no casing transform.
