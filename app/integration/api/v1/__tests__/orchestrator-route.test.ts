...
import { GET as detailGET } from '@/app/integration/api/v1/orchestrator/pipelines/[pipelineId]/route';
import { GET as listGET } from '@/app/integration/api/v1/orchestrator/pipelines/route';
import { GET as latestGET } from '@/app/integration/api/v1/orchestrator/target-sources/[targetSourceId]/pipelines/latest/route';
import { POST as createPOST } from '@/app/integration/api/v1/orchestrator/target-sources/[targetSourceId]/pipelines/route';
