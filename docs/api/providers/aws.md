...
>
> **주의 (2026-04-24)**: 본 문서의 `/api/aws/projects/{projectId}/...` 경로는 projid-removal W1-W4 merge 로 `/integration/api/v1/aws/target-sources/{targetSourceId}/...` 형태로 이관 완료되었습니다. 본 문서는 historical reference.
