...
> 해소되거나 정리되어 빠졌다(O10·O29만 미해결; 번호 gap은 의도) — 해소·정리 내역은 ADR Part III **Resolved** 및 재구성 내역 참조.
