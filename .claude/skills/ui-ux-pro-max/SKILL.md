...
Use this skill when a task involves **UI structure, visual design decisions, interaction patterns, or UX quality control**.
...
- Choosing a color scheme, typography system, spacing rules, or layout system
...
- Improving the perceived quality, clarity, or usability of the interface
...
- Receiving usability or UX-related feedback
- Polishing UI quality before launch
- Needing to align design across platforms (Web / iOS / Android)
...
- Work involving only API or database design
- Performance optimization unrelated to the interface
- Infrastructure or DevOps work
- Non-visual scripts or automation tasks

**Rule of thumb**: If a task changes how a feature **looks, feels, moves, or is interacted with**, use this skill.

## Rule Categories by Priority

*For human/AI reference: use the 1→10 priority order to decide which rule category to address first; query `--domain <Domain>` for details. Scripts do not read this table.*
...
- Default icon library: **Phosphor (`@phosphor-icons/react`)**. The icons listed in `src/ui-ux-pro-max/data/icons.csv` are common recommendations only, not the full set.
- When no suitable icon exists in the recommendation table:
  - **Prefer selecting any semantically closer icon from the full Phosphor icon set**;
  - If Phosphor has no ideal option either, use **Heroicons (`@heroicons/react`)** as a fallback, keeping the style consistent (line/fill, stroke weight, corner radius).
