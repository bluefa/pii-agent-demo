...
export const bffClient: ApiClient = {
  ...
  azure: {
    checkInstallation: (targetSourceId) => proxyPost(`/azure/target-sources/${targetSourceId}/check-installation`, {}),
    getInstallationStatus: (targetSourceId) => proxyGet(`/azure/target-sources/${targetSourceId}/installation-status`),
    getSettings: (targetSourceId) => proxyGet(`/azure/target-sources/${targetSourceId}/settings`),
    getSubnetGuide: (targetSourceId) => proxyGet(`/azure/target-sources/${targetSourceId}/subnet-guide`),
    getScanApp: (targetSourceId) => proxyGet(`/target-sources/${targetSourceId}/azure/scan-app`),
    vmCheckInstallation: (targetSourceId) => proxyPost(`/azure/target-sources/${targetSourceId}/vm/check-installation`, {}),
    vmGetInstallationStatus: (targetSourceId) => proxyGet(`/azure/target-sources/${targetSourceId}/vm/installation-status`),
    vmGetTerraformScript: (targetSourceId) => proxyGet(`/azure/target-sources/${targetSourceId}/vm/terraform-script`),
  },
  gcp: {
