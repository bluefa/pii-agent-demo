...
export const bffClient: ApiClient = {
  ...
  sdu: {
    ...
    getAthenaTables: (projectId) => proxyGet(`/sdu/projects/${projectId}/athena-tables`),
    executeConnectionTest: (projectId) => proxyPost(`/sdu/projects/${projectId}/connection-test/execute`, {}),
    getConnectionTest: (projectId) => proxyGet(`/sdu/projects/${projectId}/connection-test`),
    issueAkSk: (projectId, body) => proxyPost(`/sdu/projects/${projectId}/ak-sk`, body),
    getIamUser: (projectId) => proxyGet(`/sdu/projects/${projectId}/iam-user`),
    getInstallationStatus: (projectId) => proxyGet(`/sdu/projects/${projectId}/installation-status`),
    checkS3Upload: (projectId) => proxyPost(`/sdu/projects/${projectId}/s3-upload/check`, {}),
    getS3Upload: (projectId) => proxyGet(`/sdu/projects/${projectId}/s3-upload`),
    confirmSourceIp: (projectId, body) => proxyPost(`/sdu/projects/${projectId}/source-ip/confirm`, body),
    registerSourceIp: (projectId, body) => proxyPost(`/sdu/projects/${projectId}/source-ip/register`, body),
    getSourceIpList: (projectId) => proxyGet(`/sdu/projects/${projectId}/source-ip`),
  },
  aws: {
  ...
  idc: {
    ...
    checkInstallation: (projectId) => proxyPost(`/idc/projects/${projectId}/check-installation`, {}),
    confirmFirewall: (projectId) => proxyPost(`/idc/projects/${projectId}/confirm-firewall`, {}),
    confirmTargets: (projectId, body) => proxyPost(`/idc/projects/${projectId}/confirm-targets`, body),
    getInstallationStatus: (projectId) => proxyGet(`/idc/projects/${projectId}/installation-status`),
    getResources: (projectId) => proxyGet(`/idc/projects/${projectId}/resources`),
    updateResources: (projectId, body) => proxyPut(`/idc/projects/${projectId}/resources`, body),
    updateResourcesList: (projectId, body) => proxyPut(`/idc/projects/${projectId}/resources/list`, body),
  },
  services: {
    permissions: {
