...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    //
    // 카탈로그 **네 장에 흩어 둔다**(2026-08-17). `/access-requests` 의 "내가 접근할 수
    // 있는 서비스" 는 서버가 준 장 안에서만 OWNED 를 거르는데(계약 갭 B6), PAY·MBR 은
    // 둘 다 2·3장에 있어서 첫 장이 통째로 빈 목록이었다 — 권한이 둘이나 있는 계정에서
    // "접근할 수 있는 서비스가 없어요" 가 뜬다. 장마다 한 건 이상 걸리게 골랐다.
    //
